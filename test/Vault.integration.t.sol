...
contract VaultIntegrationTest is BaseVaultTest {
    ...
    function test_CompleteFlow_ETH_DepositFulfilSettle() public {
        ...
        assertEq(address(vault).balance - vaultBalanceBefore, depositAmount, "Vault should hold deposited ETH");
        ...
        assertEq(recipient.balance - recipientBalanceBefore, fulfilAmount, "Recipient should receive ETH");
        ...
        assertEq(solver.balance - solverBalanceBefore, settleAmount, "Solver should receive settlement");
    }
    ...
    function test_CompleteFlow_ERC20_DepositFulfilSettle() public {
        ...
        assertEq(token.balanceOf(recipient) - recipientBalanceBefore, fulfilAmount, "Recipient should receive tokens");
        ...
        assertEq(token.balanceOf(solver) - solverBalanceBefore, settleAmount, "Solver should receive settlement tokens");
    }
    ...
    function test_Upgrade_PreservesState() public {
        ...
        assertEq(vault.winningSolver(signedMessageHash1), winningSolverBefore, "Winning solver should be preserved");
