...
// import {Request, SourcePair, DestinationPair} from "../src/types.sol";
...
//     bytes32 public constant SETTLEMENT_VERIFIER_ROLE =
...
//         bytes memory signature = _signRequest(request, userPk);
//
//         (bool valid, bytes32 hash) = vault.verifyRequestSignature(
//             request,
//             signature
//         );
//
