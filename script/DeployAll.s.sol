...
contract DeployAll is Script {
    ...
    function run() external returns (DeploymentAddresses memory addresses) {
        ...
        bytes32 routerSalt = keccak256(abi.encodePacked("arcana-router-1.0.1"));
        ...
        bytes32 vaultSalt = keccak256(abi.encodePacked("arcana-vault-1.0.1"));
        ...
        bytes32 mayanSalt = keccak256(abi.encodePacked("arcana-mayanrouter-1.0.1"));
