#!/usr/bin/env python3
"""Propose Mayan token-list batches to the Safe Transaction Service.
...
Usage:
    ...
    <chain>: ethereum bsc polygon avalanche arbitrum optimism base monad
...
CHAINS = {
    ...
    # safe-eth-py has no URL mapping for monad yet, but the service exists
